...
public class RetailPageObj extends Base{
	...
	public void enterUserName() {
		userNameFiled.sendKeys("qqqqqq123456789012@gmail.com");
	}
	public void enterPassword() {
		passwordField.sendKeys("12345");
	}
	//The below two methods are for Example keyword practice
	public void enterUserNameWithParam() {
		userNameFiled.sendKeys("asas");
	}
	public void enterPasswordWithParam() {
		passwordField.sendKeys("12345");
	}	
...
//		
	...
	public void sendKeychequePayeeNameFeild() {
		chequePayeeNameFeild.sendKeys("blah");
