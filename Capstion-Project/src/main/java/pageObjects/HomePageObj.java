...
public class HomePageObj extends Base {
	...
	public void getTextchangeCurrency() throws Exception {
		String actualCurrency = changeCurrency.getText();
		String expectedCurrency = "$";
		Assert.assertEquals(expectedCurrency, actualCurrency);
	}

	public boolean shoppingCartIsEmty() {

		shoppingCartIsEmty.getText();
		return true;
	}
	...
	public void clickOnCurrency() {
		Utilities.waitAndClickElement(currency);
	...
	public void clickOnShoppingCart() {
		Utilities.waitAndClickElement(shopingCart);
	}
