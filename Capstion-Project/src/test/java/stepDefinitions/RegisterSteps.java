...
public class RegisterSteps extends Base{
	...
	public void user_click_on_agree_to_terms_checkbox() throws InterruptedException {
	...
	@When("user click on continue button again")
	public void user_click_on_continue_button_again() {
	    registerpage.clickOnAccountHasBeeCreatedContinueButton();
	}
}
